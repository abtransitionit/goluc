...
// Description
var describeSDesc = "display details for a single DaemonSet"
...
var DescribeCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		output, err := kubectl.List(kubectl.ResDs, "local", shared.HelmHost, logger)
		if err != nil {
			logger.Errorf("%v", err)
			return
		}
		...
		// describe cm
		// - get instance and operate
		i := kubectl.Resource{Type: kubectl.ResDs, Name: resName, Ns: resNs}
