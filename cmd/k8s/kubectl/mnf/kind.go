...
// Description
var KindSDesc = "list the kind of K8s resources a manifest will create into the K8s cluster"
...
var kindCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		// list the manifest resource kind
		// - get instance and operate
		i = kubectl.Resource{Type: kubectl.ResManifest, Name: resName, Url: resUrl}
		...
		// list the manifest resource kind and name
		// - get instance and operate
		i = kubectl.Resource{Type: kubectl.ResManifest, Name: resName, Url: resUrl}
