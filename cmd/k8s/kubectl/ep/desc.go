...
// Description
var describeSDesc = "display details for a single EndPoint."
...
var DescribeCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		output, err := kubectl.List(kubectl.ResEp, "local", shared.HelmHost, logger)
		if err != nil {
			logger.Errorf("%v", err)
			return
		}
		...
		// describe cm
		// - get instance and operate
		i := kubectl.Resource{Type: kubectl.ResEp, Name: resName, Ns: resNs}
